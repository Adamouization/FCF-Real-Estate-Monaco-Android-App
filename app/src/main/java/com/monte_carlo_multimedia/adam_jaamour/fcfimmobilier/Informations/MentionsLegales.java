...
/**
 * Class containing the methods used to create a functional activity for the legal mentions page.
 *
 * @author : Adam Jaamour
 * @version : 1.0
 ...
 */
public class MentionsLegales extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_mentions_legales) {
            ...
            startActivity(new Intent(MentionsLegales.this, APropos.class));
        }
        else if(id == R.id.action_aide){
            startActivity(new Intent(MentionsLegales.this, Aide.class));
        }
        return super.onOptionsItemSelected(item);
    }
    /**
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_ventes) {
            startActivity(new Intent(MentionsLegales.this, Ventes.class));
        }
        else if (id == R.id.nav_accueil) {
            startActivity(new Intent(MentionsLegales.this, Home.class));
        }
        else if (id == R.id.nav_locations) {
            startActivity(new Intent(MentionsLegales.this, Locations.class));
        }
        else if (id == R.id.nav_favoris) {
            startActivity(new Intent(MentionsLegales.this, Favoris.class));
        }
        else if (id == R.id.nav_recherche) {
            startActivity(new Intent(MentionsLegales.this, Recherche.class));
        }
        else if (id == R.id.nav_contact) {
            startActivity(new Intent(MentionsLegales.this, Contact.class));
        }
        else if (id == R.id.nav_social) {
            startActivity(new Intent(MentionsLegales.this, Social.class));
        }
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout);
        drawer.closeDrawer(GravityCompat.START);
        return true;
